; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26732.1 
	...
	TITLE	D:\edx\Raytracer\Raytracer\test.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__0D0AE54A_geometry@h DB 01H
__A7789F81_test@cpp DB 01H
...
PUBLIC	??_C@_0CM@JFLIKKCL@Enter?5the?5name?5to?5assign?5to?5out@ ; `string'
...
EXTRN	__imp_?get@?$basic_istream@DU?$char_traits@D@std@@@std@@QAEAAV12@PAD_J@Z:PROC
...
CONST	ENDS
;	COMDAT ??_C@_0CM@JFLIKKCL@Enter?5the?5name?5to?5assign?5to?5out@
CONST	SEGMENT
??_C@_0CM@JFLIKKCL@Enter?5the?5name?5to?5assign?5to?5out@ DB 'Enter the n'
	DB	'ame to assign to output image : ', 00H	; `string'
CONST	ENDS
...
; Line 97
	...
	mov	eax, -858993460				; ccccccccH
	rep stosd
	mov	ecx, OFFSET __429E0B2B_xtgmath@h
	call	@__CheckForDebuggerJustMyCode@4
...
__$EHRec$ = -12						; size = 12
_main	PROC						; COMDAT
; File d:\edx\raytracer\raytracer\test.cpp
; Line 34
	push	ebp
	mov	ebp, esp
	push	-1
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	ecx, OFFSET __A7789F81_test@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 35
	push	OFFSET ??_C@_0CM@JFLIKKCL@Enter?5the?5name?5to?5assign?5to?5out@
...
; Line 37
	...
	push	0
	push	50					; 00000032H
	lea	eax, DWORD PTR _c_name$[ebp]
	push	eax
	mov	ecx, DWORD PTR __imp_?cin@std@@3V?$basic_istream@DU?$char_traits@D@std@@@1@A
	call	DWORD PTR __imp_?get@?$basic_istream@DU?$char_traits@D@std@@@std@@QAEAAV12@PAD_J@Z
	cmp	esi, esp
	call	__RTC_CheckEsp
; Line 38
	lea	eax, DWORD PTR _c_name$[ebp]
...
; Line 39
	...
	call	?saveScreenshot@@YAXV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z ; saveScreenshot
	add	esp, 28					; 0000001cH
; Line 42
	mov	DWORD PTR _num$[ebp], 100		; 00000064H
; Line 43
	push	100					; 00000064H
